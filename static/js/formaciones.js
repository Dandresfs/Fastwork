               ...
               if(data.length == 0){
                   ...
                   for(i=0;i<data.length;i++){
                       $( ".formaciones" ).append( "<div class='formacion col-md-6'><div class='registro'>" +
                           "<a class='delete-experience' onclick='delete_formacion("+data[i].id+");'><span class='fa fa-times'></span></a>"+
                           "<a class='update-experience' onclick='update_formacion("+data[i].id+");'><span class='fa fa-pencil'></span></a>"+
                           "<p class='title-empresa'>"+data[i].nivel+"</p>"+
                           "<p>"+data[i].institucion+" - "+data[i].area+"</p>"+
                           "</div></div>" );
                   }
               }
           }
