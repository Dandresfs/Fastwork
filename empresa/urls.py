...
from .views import MisOfertasView, CrearEmpresaView, UpdateEmpresaView, ComprarCreditoEmpresa, ComprarCreditoOferta, CrearOfertaView, UpdateOfertaView
...
urlpatterns = [
    ...
    url(r'^oferta/(?P<id_oferta>\w+)/$', UpdateOfertaView.as_view()),
